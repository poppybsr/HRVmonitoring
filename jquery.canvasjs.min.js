...
this._position||"top"===this._position?0.8*this.chart.width>>0:0.8*this.chart.height>>0:1.5*this.labelFontSize,c=x(f._options.labelBackgroundColor)?x(f.startValue)&&0!==f.startValue?"transparent":"#EEEEEE":f._options.labelBackgroundColor;a=new M(this.ctx,{x:0,y:0,backgroundColor:c,maxWidth:f._options.labelMaxWidth?f._options.labelMaxWidth:g,maxHeight:t,angle:this.labelAngle,text:f.labelFormatter?f.labelFormatter({chart:this.chart._publicChartReference,axis:this,stripLine:f}):f.label,horizontalAlign:"left",
...
!0!==d.highlightEnabled&&!0!==f.highlightEnabled||("line"===d.type||"stepLine"===d.type||"spline"===d.type||"scatter"===d.type||"area"===d.type||"stepArea"===d.type||"splineArea"===d.type||"stackedArea"===d.type||"stackedArea100"===d.type||"rangeArea"===d.type||"rangeSplineArea"===d.type?(f=d.getMarkerProperties(g,e.x1,e.y1,this.chart.overlaidCanvasCtx),f.size=Math.max(1.5*f.size<<0,10),f.borderColor=f.borderColor||"#FFFFFF",f.borderThickness=f.borderThickness||Math.ceil(0.1*f.size),P.drawMarkers([f]),
